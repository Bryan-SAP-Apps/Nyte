...
struct nightatcampfire: View {
    ...
    func playAllSongs() {
                // Iterate over each song in the array and play audio
                    ...
                    if let url = Bundle.main.url(forResource: "night-at-campfire", withExtension: "mp3") {
                        do {
        ...
        ZStack{
            ...
            HStack{
                Button{
                    isPlayingMusic = true
                    playAllSongs()
                    savedSound = "night-at-campfire"
                    progress -= progress
                    progress2 = 0.003
                    
                }label:{
                    Text("night-at-campfire")
                        .foregroundColor(.red)
                        .font(.title)
                        .padding()
                }
